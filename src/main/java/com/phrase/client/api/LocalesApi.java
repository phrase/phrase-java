...
public class LocalesApi {
     ...
     * @param branch specify the branch to use (optional)
     * @param fileFormat File format name. See the [format guide](https://support.phrase.com/hc/en-us/sections/6111343326364) for all supported file formats. (optional)
     ...
     * @param formatOptions Additional formatting and render options. See the [format guide](https://support.phrase.com/hc/en-us/sections/6111343326364) for a list of options available for each format. Specify format options like this: &#x60;...&amp;format_options[foo]&#x3D;bar&#x60; (optional)
     * @param encoding Enforces a specific encoding on the file contents. Valid options are \&quot;UTF-8\&quot;, \&quot;UTF-16\&quot; and \&quot;ISO-8859-1\&quot;. (optional)
     * @param skipUnverifiedTranslations Indicates whether the locale file should skip all unverified translations. This parameter is deprecated and should be replaced with &#x60;include_unverified_translations&#x60;. (optional)
     ...
     * @param filterByPrefix Only download translation keys containing the prefix specified by &#x60;translation_key_prefix&#x60;, and remove that prefix from the generated file. Requires &#x60;translation_key_prefix&#x60; to be set. (optional)
    ...
    public okhttp3.Call localeDownloadCall(String projectId, String id, String xPhraseAppOTP, String ifModifiedSince, String ifNoneMatch, String branch, String fileFormat, String tags, String tag, Boolean includeEmptyTranslations, Boolean excludeEmptyZeroForms, Boolean includeTranslatedKeys, Boolean keepNotranslateTags, Boolean convertEmoji, Object formatOptions, String encoding, Boolean skipUnverifiedTranslations, Boolean includeUnverifiedTranslations, Boolean useLastReviewedVersion, String fallbackLocaleId, Boolean useLocaleFallback, Boolean fallbackForUnverifiedTranslations, String sourceLocaleId, String translationKeyPrefix, Boolean filterByPrefix, Object customMetadataFilters, List<String> localeIds, String updatedSince, final ApiCallback _callback) throws ApiException {
        ...
        if (useLocaleFallback != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("use_locale_fallback", useLocaleFallback));
        }

        if (fallbackForUnverifiedTranslations != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("fallback_for_unverified_translations", fallbackForUnverifiedTranslations));
        }
        ...
        if (translationKeyPrefix != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("translation_key_prefix", translationKeyPrefix));
        }

        if (filterByPrefix != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("filter_by_prefix", filterByPrefix));
        }

        if (customMetadataFilters != null) {
    ...
    private okhttp3.Call localeDownloadValidateBeforeCall(String projectId, String id, String xPhraseAppOTP, String ifModifiedSince, String ifNoneMatch, String branch, String fileFormat, String tags, String tag, Boolean includeEmptyTranslations, Boolean excludeEmptyZeroForms, Boolean includeTranslatedKeys, Boolean keepNotranslateTags, Boolean convertEmoji, Object formatOptions, String encoding, Boolean skipUnverifiedTranslations, Boolean includeUnverifiedTranslations, Boolean useLastReviewedVersion, String fallbackLocaleId, Boolean useLocaleFallback, Boolean fallbackForUnverifiedTranslations, String sourceLocaleId, String translationKeyPrefix, Boolean filterByPrefix, Object customMetadataFilters, List<String> localeIds, String updatedSince, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = localeDownloadCall(projectId, id, xPhraseAppOTP, ifModifiedSince, ifNoneMatch, branch, fileFormat, tags, tag, includeEmptyTranslations, excludeEmptyZeroForms, includeTranslatedKeys, keepNotranslateTags, convertEmoji, formatOptions, encoding, skipUnverifiedTranslations, includeUnverifiedTranslations, useLastReviewedVersion, fallbackLocaleId, useLocaleFallback, fallbackForUnverifiedTranslations, sourceLocaleId, translationKeyPrefix, filterByPrefix, customMetadataFilters, localeIds, updatedSince, _callback);
        return localVarCall;
     ...
     */
    public File localeDownload(String projectId, String id, String xPhraseAppOTP, String ifModifiedSince, String ifNoneMatch, String branch, String fileFormat, String tags, String tag, Boolean includeEmptyTranslations, Boolean excludeEmptyZeroForms, Boolean includeTranslatedKeys, Boolean keepNotranslateTags, Boolean convertEmoji, Object formatOptions, String encoding, Boolean skipUnverifiedTranslations, Boolean includeUnverifiedTranslations, Boolean useLastReviewedVersion, String fallbackLocaleId, Boolean useLocaleFallback, Boolean fallbackForUnverifiedTranslations, String sourceLocaleId, String translationKeyPrefix, Boolean filterByPrefix, Object customMetadataFilters, List<String> localeIds, String updatedSince) throws ApiException {
    ...
    public ApiResponse<File> localeDownloadWithHttpInfo(String projectId, String id, String xPhraseAppOTP, String ifModifiedSince, String ifNoneMatch, String branch, String fileFormat, String tags, String tag, Boolean includeEmptyTranslations, Boolean excludeEmptyZeroForms, Boolean includeTranslatedKeys, Boolean keepNotranslateTags, Boolean convertEmoji, Object formatOptions, String encoding, Boolean skipUnverifiedTranslations, Boolean includeUnverifiedTranslations, Boolean useLastReviewedVersion, String fallbackLocaleId, Boolean useLocaleFallback, Boolean fallbackForUnverifiedTranslations, String sourceLocaleId, String translationKeyPrefix, Boolean filterByPrefix, Object customMetadataFilters, List<String> localeIds, String updatedSince) throws ApiException {
        okhttp3.Call localVarCall = localeDownloadValidateBeforeCall(projectId, id, xPhraseAppOTP, ifModifiedSince, ifNoneMatch, branch, fileFormat, tags, tag, includeEmptyTranslations, excludeEmptyZeroForms, includeTranslatedKeys, keepNotranslateTags, convertEmoji, formatOptions, encoding, skipUnverifiedTranslations, includeUnverifiedTranslations, useLastReviewedVersion, fallbackLocaleId, useLocaleFallback, fallbackForUnverifiedTranslations, sourceLocaleId, translationKeyPrefix, filterByPrefix, customMetadataFilters, localeIds, updatedSince, null);
     ...
     */
    public okhttp3.Call localeDownloadAsync(String projectId, String id, String xPhraseAppOTP, String ifModifiedSince, String ifNoneMatch, String branch, String fileFormat, String tags, String tag, Boolean includeEmptyTranslations, Boolean excludeEmptyZeroForms, Boolean includeTranslatedKeys, Boolean keepNotranslateTags, Boolean convertEmoji, Object formatOptions, String encoding, Boolean skipUnverifiedTranslations, Boolean includeUnverifiedTranslations, Boolean useLastReviewedVersion, String fallbackLocaleId, Boolean useLocaleFallback, Boolean fallbackForUnverifiedTranslations, String sourceLocaleId, String translationKeyPrefix, Boolean filterByPrefix, Object customMetadataFilters, List<String> localeIds, String updatedSince, final ApiCallback<File> _callback) throws ApiException {
