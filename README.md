...
```groovy
compile "com.phrase:phrase-java:3.26.0"
```
...
*BranchesApi* | [**branchComparisonCreate**](docs/BranchesApi.md#branchComparisonCreate) | **POST** /projects/{project_id}/branches/{name}/compare | Create comparison (async.)
...
*MembersApi* | [**membersByProject**](docs/MembersApi.md#membersByProject) | **GET** /projects/{project_id}/members | List project members
...
*RepoSyncsApi* | [**repoSyncCreate**](docs/RepoSyncsApi.md#repoSyncCreate) | **POST** /accounts/{account_id}/repo_syncs | Create a Repo Sync
...
## Documentation for Models
 ...
 - [BranchComparisonChange](docs/BranchComparisonChange.md)
 - [BranchComparisonDiff](docs/BranchComparisonDiff.md)
 - [BranchComparisonDiffConflictsValue](docs/BranchComparisonDiffConflictsValue.md)
 ...
 - [DistributionDetails](docs/DistributionDetails.md)
 - [DistributionUpdateParameters](docs/DistributionUpdateParameters.md)
 - [Document](docs/Document.md)
 - [DocumentDelete422Response](docs/DocumentDelete422Response.md)
 - [DocumentDelete422ResponseErrorsInner](docs/DocumentDelete422ResponseErrorsInner.md)
 - [Error](docs/Error.md)
 ...
 - [GlossaryTermGlossary](docs/GlossaryTermGlossary.md)
 ...
 - [RepoSyncCreateParameters](docs/RepoSyncCreateParameters.md)
 ...
 - [ScreenshotMarkerPresentation](docs/ScreenshotMarkerPresentation.md)
