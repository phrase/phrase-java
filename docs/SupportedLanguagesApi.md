...
import com.phrase.client.api.SupportedLanguagesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    SupportedLanguagesApi apiInstance = new SupportedLanguagesApi(defaultClient);
    try {
      Map<String, String> result = apiInstance.languagesList();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SupportedLanguagesApi#languagesList");
