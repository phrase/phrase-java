...
# **reactionCreate**
> CommentReaction reactionCreate(projectId, keyId, commentId, xPhraseAppOTP, branch)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CommentReaction result = apiInstance.reactionCreate(projectId, keyId, commentId, xPhraseAppOTP, branch);
