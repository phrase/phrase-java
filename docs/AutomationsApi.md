...
<a name="automationActivate"></a>
# **automationActivate**
> Automation automationActivate(accountId, id, xPhraseAppOTP)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Automation result = apiInstance.automationActivate(accountId, id, xPhraseAppOTP);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AutomationsApi#automationActivate");
...
<a name="automationCreate"></a>
# **automationCreate**
> Automation automationCreate(accountId, automationsCreateParameters, xPhraseAppOTP)
...
public class Example {
  public static void main(String[] args) {
    ...
    AutomationsApi apiInstance = new AutomationsApi(defaultClient);
    String accountId = "accountId_example"; // String | Account ID
    AutomationsCreateParameters automationsCreateParameters = new AutomationsCreateParameters(); // AutomationsCreateParameters | 
    String xPhraseAppOTP = "xPhraseAppOTP_example"; // String | Two-Factor-Authentication token (optional)
    try {
      Automation result = apiInstance.automationCreate(accountId, automationsCreateParameters, xPhraseAppOTP);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AutomationsApi#automationCreate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="automationDeactivate"></a>
# **automationDeactivate**
> Automation automationDeactivate(accountId, id, xPhraseAppOTP)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xPhraseAppOTP = "xPhraseAppOTP_example"; // String | Two-Factor-Authentication token (optional)
    try {
      Automation result = apiInstance.automationDeactivate(accountId, id, xPhraseAppOTP);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AutomationsApi#automationDeactivate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="automationDelete"></a>
# **automationDelete**
> automationDelete(accountId, id, xPhraseAppOTP)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xPhraseAppOTP = "xPhraseAppOTP_example"; // String | Two-Factor-Authentication token (optional)
    try {
      apiInstance.automationDelete(accountId, id, xPhraseAppOTP);
    } catch (ApiException e) {
      System.err.println("Exception when calling AutomationsApi#automationDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="automationShow"></a>
# **automationShow**
> Automation automationShow(accountId, id, xPhraseAppOTP)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xPhraseAppOTP = "xPhraseAppOTP_example"; // String | Two-Factor-Authentication token (optional)
    try {
      Automation result = apiInstance.automationShow(accountId, id, xPhraseAppOTP);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AutomationsApi#automationShow");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String accountId = "accountId_example"; // String | Account ID
    String id = "id_example"; // String | ID
    AutomationsCreateParameters1 automationsCreateParameters1 = new AutomationsCreateParameters1(); // AutomationsCreateParameters1 | 
    String xPhraseAppOTP = "xPhraseAppOTP_example"; // String | Two-Factor-Authentication token (optional)
    try {
      Automation result = apiInstance.automationUpdate(accountId, id, automationsCreateParameters1, xPhraseAppOTP);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AutomationsApi#automationUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **automationsList**
> List&lt;Automation&gt; automationsList(accountId, xPhraseAppOTP, page, perPage)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<Automation> result = apiInstance.automationsList(accountId, xPhraseAppOTP, page, perPage);
      System.out.println(result);
    } catch (ApiException e) {
