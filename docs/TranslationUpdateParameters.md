...
**minorChange** | **Boolean** | When &#x60;true&#x60;, the update is treated as a minor edit and does not trigger downstream re-verification on the linked locales&#39; translations.  |  [optional]
