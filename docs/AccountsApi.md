...
# **accountShow**
> AccountDetails accountShow(id, xPhraseAppOTP)
...
# **accountsList**
> List&lt;Account&gt; accountsList(xPhraseAppOTP, page, perPage)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<Account> result = apiInstance.accountsList(xPhraseAppOTP, page, perPage);
      System.out.println(result);
    } catch (ApiException e) {
