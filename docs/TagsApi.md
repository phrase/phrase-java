...
<a name="tagsList"></a>
# **tagsList**
> List&lt;Tag&gt; tagsList(projectId, xPhraseAppOTP, page, perPage, excludeSystemTags, branch, q)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<Tag> result = apiInstance.tagsList(projectId, xPhraseAppOTP, page, perPage, excludeSystemTags, branch, q);
      System.out.println(result);
    } catch (ApiException e) {
