...
import com.phrase.client.api.TermBaseTranslationApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TermBaseTranslationApi apiInstance = new TermBaseTranslationApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling TermBaseTranslationApi#glossaryTermTranslationDelete");
