...
<a name="repoSyncCreate"></a>
# **repoSyncCreate**
> RepoSync repoSyncCreate(accountId, repoSyncCreateParameters, xPhraseAppOTP)
...
public class Example {
  public static void main(String[] args) {
    ...
    RepoSyncsApi apiInstance = new RepoSyncsApi(defaultClient);
    String accountId = "accountId_example"; // String | Account ID
    RepoSyncCreateParameters repoSyncCreateParameters = new RepoSyncCreateParameters(); // RepoSyncCreateParameters | 
    String xPhraseAppOTP = "xPhraseAppOTP_example"; // String | Two-Factor-Authentication token (optional)
    try {
      RepoSync result = apiInstance.repoSyncCreate(accountId, repoSyncCreateParameters, xPhraseAppOTP);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RepoSyncsApi#repoSyncCreate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
