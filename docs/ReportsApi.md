...
import com.phrase.client.api.ReportsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    String localeCodes = "localeCodes_example"; // String | Locale Code
    String tag = "tag_example"; // String | tag
    String branch = "my-feature-branch"; // String | specify the branch to use
    try {
      List<LocaleReport> result = apiInstance.reportLocalesList(projectId, xPhraseAppOTP, page, perPage, localeCodes, tag, branch);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ReportsApi#reportLocalesList");
 ...
 **localeCodes** | **String**| Locale Code | [optional]
...
<a name="reportShow"></a>
# **reportShow**
> ProjectReport reportShow(projectId, xPhraseAppOTP, branch)
...
public class Example {
  public static void main(String[] args) {
    ...
    String branch = "my-feature-branch"; // String | specify the branch to use
    try {
      ProjectReport result = apiInstance.reportShow(projectId, xPhraseAppOTP, branch);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ReportsApi#reportShow");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
