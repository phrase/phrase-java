...
# **distributionCreate**
> distributionCreate(accountId, distributionCreateParameters, xPhraseAppOTP)
...
import org.phrase.client.api.DistributionsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.distributionCreate(accountId, distributionCreateParameters, xPhraseAppOTP);
